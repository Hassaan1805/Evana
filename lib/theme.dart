...
const Color lightPrimary = Color(0xFFE91E63);         // Pink primary - women empowerment
...
final ThemeData lightTheme = ThemeData(
  ...
  textTheme: GoogleFonts.poppinsTextTheme(ThemeData.light().textTheme).copyWith(
    ...
    headlineLarge: const TextStyle(color: lightText, fontWeight: FontWeight.bold, fontSize: 32),
    headlineMedium: const TextStyle(color: lightText, fontWeight: FontWeight.bold, fontSize: 24),
    headlineSmall: const TextStyle(color: lightText, fontWeight: FontWeight.bold, fontSize: 20),
    titleLarge: const TextStyle(color: lightText, fontWeight: FontWeight.w600, fontSize: 18),
    titleMedium: const TextStyle(color: lightText, fontWeight: FontWeight.w600, fontSize: 16),
  ),
...
final ThemeData darkTheme = ThemeData(
  ...
  textTheme: GoogleFonts.poppinsTextTheme(ThemeData.dark().textTheme).copyWith(
    ...
    headlineLarge: const TextStyle(color: darkText, fontWeight: FontWeight.bold, fontSize: 32),
    headlineMedium: const TextStyle(color: darkText, fontWeight: FontWeight.bold, fontSize: 24),
    headlineSmall: const TextStyle(color: darkText, fontWeight: FontWeight.bold, fontSize: 20),
    titleLarge: const TextStyle(color: darkText, fontWeight: FontWeight.w600, fontSize: 18),
    titleMedium: const TextStyle(color: darkText, fontWeight: FontWeight.w600, fontSize: 16),
  ),
  appBarTheme: const AppBarTheme(
